...
export function CaseCardSkeleton() {
    return (
      <div className="block h-full">
        <Card className="h-full transition-shadow duration-100">
          ...
          <CardFooter className="flex items-center gap-4 text-sm text-muted-foreground bg-transparent py-2 px-4">
    ...
    return (
        ...
        >
            <Card className="group-hover:shadow-sm transition-shadow duration-100 h-full!">
                ...
                <CardFooter className="flex items-center gap-4 text-sm text-muted-foreground bg-transparent py-2 px-44">
                    <span className="inline-flex items-center gap-1.5">
