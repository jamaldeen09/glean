...
export default function CasesGrid() {
    ...
    return (
        <ul className="grid gap-x-5 gap-y-9 pt-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {!isFetchNextPageError && (
                <Card
                className="flex h-full w-full cursor-pointer flex-col items-center justify-center gap-3 px-6 py-7.5
              ring-0  hover:bg-muted bg-transparent transition-all duration-200"
                role="button" 
                tabIndex={0}
            >
                 <span className="flex h-10 w-10 items-center justify-center rounded-full border border-dashed border-destructive/40">
