...
import { CreateDocketArg } from "@/app/workspace/_actions";
import { timeAgo } from "@/lib/utils";

export interface DocketMetadata extends CreateDocketArg {
    id: string;
    status: DocketStatus;
...
export default function CaseCard({ case: c }: { case: DocketMetadata }) {
    return (
        <Link
