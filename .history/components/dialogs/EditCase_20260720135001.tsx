...
import { EditCaseData } from "@/app/workspace/_actions"
import { useEditCase } from "@/hooks/case/use-edit-case"
...
export default function EditCase({ caseData, caseId }: { caseData: EditCaseData, caseId: string; } ) {
    const { mutate, isPending } = useEditCase();
        ...
        <Dialog>
            ...
            <DialogContent className="sm:max-w-md">
                ...
                <DialogFooter className="bg-transparent!">
                    ...
                    <Button 
                      type="submit" form="form-edit-case" disabled={isPending}>
