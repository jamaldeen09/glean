...
import { useDeleteCase } from "@/hooks/case/use-delete-case"
import { useCallback } from "react"

export default function DeleteCaseConfirmation({ caseId }: { caseId: string }) {
        ...
        <AlertDialog>
            ...
            <AlertDialogContent>
                ...
                <AlertDialogFooter className="bg-transparent">
                    ...
                    <AlertDialogAction onClick={() => handl}>
                        Delete case
                    </AlertDialogAction>
                </AlertDialogFooter>
            </AlertDialogContent>
