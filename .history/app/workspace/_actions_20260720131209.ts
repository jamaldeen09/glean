...
export const createCase = async (args: CreateCaseArgs) => {
    try {
        ...
        try {
            ...
            const fallback = "An unexpected error occured while attempting to open a new case."
...
export const editCase = async (args: Partial<Omit<CaseMetadata, "totalExhibits" | "totalParties" | "updatedAt">>) => {
    try {
        ...
        try {} catch (err) {
            const fallback = "An error occured while attempting to update this case's details.  Please try again shortly"
